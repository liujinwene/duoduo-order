...
public class SubThirdOrder {
	...
	private String is_follow_arbitration;
	...
	public void setCombo_amount(String combo_amount) {
	...
	public Object getPost_addr() {
		return post_addr;
	}
	public void setPost_addr(Object post_addr) {
	...
	public String getUrge_cnt() {
		return urge_cnt;
	}
	public void setUrge_cnt(String urge_cnt) {
	...
	public String getIs_follow_arbitration() {
		return is_follow_arbitration;
	}
	public void setIs_follow_arbitration(String is_follow_arbitration) {
		this.is_follow_arbitration = is_follow_arbitration;
	}
